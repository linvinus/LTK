...
LTK_FLAGS = --vapidir $(LTK_TOP)vapi  --pkg gobject-2.0 --pkg posix  --pkg glib-2.0 --pkg gio-2.0 --pkg gio-unix-2.0 --pkg xcb --pkg xcb-icccm --pkg cairo-xcb -X -lfreetype -X -lxcb-keysyms
